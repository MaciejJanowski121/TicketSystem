...
function WikiPage() {
  const [isHelpExpanded, setIsHelpExpanded] = useState(true); // Start expanded since this is a dedicated page
    ...
    <div className="page-dashboard">
      <div className="content-section">
        <div className="page-header">
          <h1>Hilfe & Erklärung</h1>
          <p>Umfassende Anleitung zum TicketSystem</p>
        </div>

        <div className="help-section">
          <div className="help-header" onClick={toggleHelp}>
            <h2>Ticket-System Dokumentation</h2>
